...
FIREBASE_CONFIG = {
    ...
    "authDomain": os.environ.get('FIREBASE_AUTH_DOMAIN', 'child-learning-center-auth.firebaseapp.com'),
    "projectId": os.environ.get('FIREBASE_PROJECT_ID', 'child-learning-center-auth'),
    "storageBucket": os.environ.get('FIREBASE_STORAGE_BUCKET', 'child-learning-center-auth.firebasestorage.app'),
